    ...
    <div>
      <div className="card h-full bg-base-100 shadow-xl border">
        <figure className="p-6 ">
          <img className="h-60 w-full object-cover rounded-xl" src={recipe_image} alt="Shoes"/>
        </figure>
        <div className="card-body -mt-10">
          <h2 className="card-title lexend-font">{recipe_name}</h2>
          <p>{short_description}</p>
          <hr />
          <h5 className="lexend-font text-xl">Ingredients: <span>{ingredients.length}</span></h5>
